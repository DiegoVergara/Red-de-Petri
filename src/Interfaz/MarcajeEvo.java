 ...
 * @author ramirodavid
 */
public class MarcajeEvo extends JFrame{
    
        TableRowSorter<TableModel> sorter;
    // metodo para crear las tablas de marcaje en evolución
    public MarcajeEvo(ArrayList<circuloEvolucion> circulo, JTable jTableMar, int b) {
        //título y tamaño
        super("Marcaje");
	this.setSize(300,500);
        ...
        // se crea el vector filas para el almacenaje de las filas
        Vector filas = new Vector();
        for (circuloEvolucion c: circulo){// se recorren las plazas
